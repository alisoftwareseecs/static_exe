...
// HOW TO RUN:
//   1. Put IdleAnimation.java and Idle_2.png in the same folder
//   2. Compile: javac IdleAnimation.java
//   3. Run:     java IdleAnimation
//
// CONTROLS:
//   SPACE = pause / resume
//   +     = speed up
...
public class IdleAnimation extends JPanel implements Runnable {

    private static final String FILE_NAME   = "Idle_2.png";
    ...
    public void start() {
        running = true;
        Thread t = new Thread(this, "idle-anim");
        t.setDaemon(true);
        t.start();
    }
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            IdleAnimation anim = new IdleAnimation();
            anim.start();
